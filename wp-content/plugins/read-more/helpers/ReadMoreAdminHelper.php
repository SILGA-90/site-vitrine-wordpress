	...
	public static function getMaxOepnContent($firstHeader, $type) {
		...
		<div class="yrm-review-wrapper">
			...
			<div class="yrm-buttons-wrapper">
				...
				<button class="press press-grey yrm-button-2 yrm-show-period" data-ajaxnonce="<?php echo esc_attr($ajaxNonce); ?>" data-message-type="<?php echo $type; ?>">Maybe later</button></div>
			<div> </div>
		</div>
		<?php
		$content = ob_get_clean();
