...
<div class="expm-wrapper">
	...
	<div class="row">
		<div class="col-xs-12">
			<input type="text" name="expm-title" class="form-control input-md" placeholder="Read more title" value="<?php echo $typeObj->getOptionValue('expm-title'); ?>">
		</div>
	</div>
				...
				<div class="row row-static-margin-bottom">
					...
					<div class="col-xs-4">
						<label class="yrm-switch">
							<input type="checkbox" id="show-less-scroll-top" name="show-less-scroll-top" class="yrm-accordion-checkbox" <?php echo $typeObj->getOptionValue('show-less-scroll-top'); ?>>
		...
		<div class="panel panel-default yrm-pro-options-wrapper">
			...
			<div class="panel-body">
				...
				<div class="row row-static-margin-bottom">
					...
					<div class="col-xs-4">
						<label class="yrm-switch">
							<input type="checkbox" id="arm-show-on-selected-devices" name="arm-show-on-selected-devices" class="yrm-accordion-checkbox" <?php echo $typeObj->getOptionValue('arm-show-on-selected-devices'); ?>>
							<span class="yrm-slider yrm-round"></span>
						</label>
					</div>
				</div>
				<div class="yrm-accordion-content yrm-hide-content">
					...
					<div class="row row-static-margin-bottom">
						...
						<div class="col-xs-4">
							<label class="yrm-switch">
								<input type="checkbox" id="arm-hide-content" name="arm-hide-content" class="yrm-accordion-checkbox" <?php echo $typeObj->getOptionValue('arm-hide-content'); ?>>
								<span class="yrm-slider yrm-round"></span>
							</label>
						</div>
					</div>
				...
				<div class="row row-static-margin-bottom">
					...
					<div class="col-xs-4">
						<label class="yrm-switch">
							<input type="checkbox" id="shover-effect" name="hover-effect" class="yrm-accordion-checkbox" <?php echo $typeObj->getOptionValue('hover-effect'); ?>>
							<span class="yrm-slider yrm-round"></span>
						</label>
					</div>
				</div>
